export const projectsData = [
    {
        id: 1,
        name: 'Silverkuun Loans - Fintech Lending Platform',
        description: "Architected and developed a full-stack financial services platform for digital lending and loan management. Built RESTful APIs with Express and Node.js to handle loan applications, user management, and transaction processing with MongoDB database integration. Implemented secure authentication system using Google OAuth, managing user sessions and protecting sensitive financial data. Designed responsive frontend using React and TypeScript with Redux for centralized state management across complex loan application workflows. Integrated Paystack payment gateway for secure loan disbursements and repayments, with real-time transaction tracking and automated payment reminders.",
        tools: ['React', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'Redux', 'Google OAuth', 'Paystack API', 'Tailwind CSS', 'REST API'],
        role: 'Full Stack Developer',
        code: 'https://github.com/Smartty23',
        demo: 'https://silverkuunloans.com/',
    },
    {
        id: 2,
